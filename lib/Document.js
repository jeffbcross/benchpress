...
function Document(values, utils, runner, scripts, locals) {
  this._values = values;
  this._utils = utils;
  this._scripts = scripts;
  this._runner = runner;
  this._window = (locals && locals.win) || window;
}
